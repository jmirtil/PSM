...
public class courseSelect extends javax.swing.JFrame {
   ...
   public courseSelect(LogicFacade lfacade) {
	   
	   /*These lines were most likely used to debug*/
	    logicFacade = lfacade;
        String ans = lfacade.fetchCourses();
   ...
   public boolean courseSelected()
    ...
    public void launchCourse() {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new courseSelect(logicFacade).setVisible(true);
            }
        });
    }
