...
public class appControllerTest {
	...
	public void runBeforeAllTest() {
		...
		dataStub = new DataStoreFacadeStub("user", "pw"); // stubbed date store
															// facade
		app.setDataStoreFacade(dataStub);
		app.setAuthenticate(new AuthenticateStub("user", "pw")); // inject
																	// authenticate
																	// stub
		InterfaceControllerStub interfaceStub = new InterfaceControllerStub(
				iFacade); // stubbed interface Controller
	...
	public void testAppEditSched2() {
		...
		iFacade.testHelper("CEN", "Software Testing", "Fall", "06/15/16",
				"07/15/16", null, null, "04:30", "06:15", null, null, "04:30",
	...
	public void testSetupSched2() {
		...
		Assert.assertEquals(dataStub.defCourseName.get(4072),
				"Software Testing");
	...
	public void testAppLogin02() {
		...
		// --Expect to unsuccessfully login. And method returns from 3 failed
		// attempts.
		assertEquals(app.getLoggedIn(), false);
	...
	public void testCheckClear03() {
		...
		dataStub.testHelper(4072, "CEN", "Software Testing", "SummerA",
				"04/31/16", "07/31/16", null, null, "04:30", "06:15", null,
				null, "04:30", "06:15", null, null, null, null);
		dataStub.testHelper(4010, "CEN", "Software Engineering", "SummerA",
				"04/28/16", "07/28/16", null, null, "04:30", "06:15", null,
				null, "04:30", "06:15", null, null, null, null);
	...
	public void testGetData() {
		// --Precondition: Database contains the following info
		dataStub.testHelper(4072, "CEN", "Software Testing", "SummerA",
				"06/15/16", "07/15/16", null, null, "04:30", "06:15", null,
				null, "04:30", "06:15", null, null, null, null);

		app.getData(4072);

		// --Expect the fields of app to change to the corresponding data in the
		// database
	...
	public void testGetEndTime() {
		...
		assertEquals(app.getEndTime(4, 30).toString().substring(11, 16),
				"04:29");
	}
	...
	public void testGet15BeforeEnd() {
		...
		assertEquals(app.get15BeforeEnd(4, 30).toString().substring(11, 16),
				"04:15");
	}
	...
	public void testGet15BeforeEnd02() {
		...
		assertEquals(app.get15BeforeEnd(4, 10).toString().substring(11, 16),
				"03:55");
	}
	...
	public void testGet5BeforeEnd() {
		...
		date.set(Calendar.YEAR, Calendar.MONTH, Calendar.DATE, 4, 25, 1);

		// --Expect a date that has hr = 4, min = 25
		assertEquals(app.get5BeforeEnd(4, 30).toString().substring(11, 16),
				"04:25");
	}
	...
	public void testGet5BeforeEnd02() {
		Calendar date = new GregorianCalendar();
		date.set(Calendar.YEAR, Calendar.MONTH, Calendar.DATE, 3, 58, 1);

		// --Expect a date that has hr = 3, min = 58
		assertEquals(app.get5BeforeEnd(4, 3).toString().substring(11, 16),
				"03:58");
	}
}
